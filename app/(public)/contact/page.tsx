                    ...
                    <div className="md:col-span-2 flex flex-col gap-6">
                        ...
                        <div className="glass rounded-2xl p-7">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {socials.map((s, i) => (
                                    <a key={i} href={s.href} className="flex items-center gap-2.5 p-3 rounded-xl bg-white/5 hover:bg-[var(--primary)]/15 text-neutral-400 hover:text-[var(--primary)] transition-all duration-200 text-sm font-medium">
                                        {s.icon} {s.label}
                                    </a>
                                ))}
                            </div>
                                ...
                                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                                        ...
                                        {[
                                            ...
                                            <div key={field.name}>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/8 text-white placeholder-neutral-600 focus:outline-none focus:border-[var(--primary)]/50 focus:bg-white/8 transition-all text-sm"
                                                />
                                            </div>
                                        ))}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            value={form.message}
                                            onChange={handleChange}
                                            className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/8 text-white placeholder-neutral-600 focus:outline-none focus:border-[var(--primary)]/50 focus:bg-white/8 transition-all text-sm resize-none"
                                        />
                                    </div>
                                    <button
                                        type="submit"
