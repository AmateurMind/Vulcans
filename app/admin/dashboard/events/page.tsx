        ...
        <div className="p-8">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-neutral-500 text-sm">{events?.length ?? 0} events uploaded</p>
                </div>
                <button
                ...
                <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="glass rounded-2xl p-7 w-full max-w-lg">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            ...
                            {/* Image Upload */}
                            <div>
                                <label className="block text-xs font-semibold text-neutral-400 uppercase tracking-wider mb-1.5">Image (optional)</label>
                                {preview
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {events === undefined && <p className="text-neutral-500 text-sm col-span-3">Loading...</p>}
                {events?.length === 0 && (
                    <div className="col-span-3 glass rounded-2xl p-12 text-center text-neutral-500">
    ...
    return (
        <div className="glass rounded-2xl overflow-hidden group hover:border-white/15 transition-all">
            ...
            <div className="p-4">
                ...
                <p className="text-neutral-500 text-xs mb-2">{event.date}</p>
