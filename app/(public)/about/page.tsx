...
const values = [
    { icon: <Target className="w-6 h-6 text-[var(--primary)]" />, title: "Excellence", desc: "We strive for the highest standards in everything we build." },
        ...
        <main className="min-h-screen bg-[#030712] text-white">
            ...
            <section className="pt-32 pb-20 px-6 grid-bg relative">
                ...
                <div className="max-w-4xl mx-auto text-center relative">
                    <p className="text-[var(--primary)] font-semibold text-sm tracking-widest uppercase mb-4">About Us</p>
            ...
            <section className="py-20 px-6">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="relative">
                        <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-[var(--primary)]/50 via-[var(--primary)]/30 to-transparent" />
