...
export default function DashboardPage() {
    ...
    return (
        <div className="p-8">
            ...
            <p className="text-neutral-500 text-sm mb-8">Welcome back, Admin.</p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10">
                {stats.map((s, i) => (
                    <Link key={i} href={s.href} className={`glass p-6 rounded-2xl bg-gradient-to-br ${s.color} hover:border-white/15 transition-all duration-200 hover:-translate-y-0.5 group`}>
